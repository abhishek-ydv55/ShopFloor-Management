                ...
                <tr>
                  ...
                  <td style="text-align:center;">
                    <div style="display:flex; gap:8px; justify-content:center;">
                      ...
                      <span [title]="w.role.toLowerCase() === 'admin' ? 'Admin accounts cannot be deleted' : ''">
                        <app-button variant="danger" size="sm" [disabled]="w.role.toLowerCase() === 'admin'" (clicked)="deleteWorker(w.empId, w.name)">Delete</app-button>
                      </span>
                    </div>
                  </td>
                </tr>
